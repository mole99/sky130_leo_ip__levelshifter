...
N 420 160 520 160 {
lab=in}
C {sky130_leo_ip__levelshifter_up.sym} 620 160 0 0 {name=x1}
...
C {devices/vsource.sym} 420 210 0 0 {name=V5 value="pulse 0 1.8 0 100p 100p 10n 20n" savecurrent=false}
